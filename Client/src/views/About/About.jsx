    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.card}>
                <div className={styles.img}><img src={logo} alt="" className={styles.logo} /></div>

                <span className={styles.span}>About Me</span>
                <p className={styles.info}>I’m Matias, a full stack Developer.</p>
                <div className={styles.share}>
                    <a href="https://github.com/assaffmatias" target='__BLANK'>
